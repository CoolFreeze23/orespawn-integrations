 ...
 *
 * <p>Why this works with zero subclassing (verified against
 ...
 *
 * <p>API citations, all javap-verified in artifacts-neoforge-13.2.1:
 * <ul>
 ...
 *       where cooldown is in SECONDS ({@code addCooldown(item, cooldown * 20)})</li>
