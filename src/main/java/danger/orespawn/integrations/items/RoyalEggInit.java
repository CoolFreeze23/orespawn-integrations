 ...
 * (long incubation; the hatchling is a living trophy).
 ...
 *
 * <p>Feature contract (all verified against the pack jars / port mirror):
 * <ul>
 ...
 *       first server tick, so the hatchling imprints on whoever is brooding over
