...
- **Brazilian critters become Domestication Innovation pets.** Three
  ...
  - **Capivara** — a Corn Cob (OreSpawn's), a Manga, or a Melon Slice. One in three.
  - **Quero-quero** — any seed a parrot would eat. One in three. It defends its owner,
    which anyone who has walked past one already knows.
  - **Urutau** — a Moth Scale, and only a Moth Scale (Luna Moths drop them, Mothra
    drops a pile). One in two, because you had to catch a moth first.
- **Nothing to add for the Vira-lata Caramelo, Pintinho, Ovinho or Amongus** — they are
  tameable in their own mod already, and Domestication Innovation treats them like any
  wolf or cat once they are: collars, enchantments, beds and lanterns just work.
